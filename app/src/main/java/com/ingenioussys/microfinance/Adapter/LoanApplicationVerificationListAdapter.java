...
import com.ingenioussys.microfinance.Activites.FieldManager.LoanApplications.ApproveLoan;
...
public class LoanApplicationVerificationListAdapter extends MultiLevelAdapter {
    ...
    public LoanApplicationVerificationListAdapter(Context mContext, List<Item> mListItems, MultiLevelRecyclerView mMultiLevelRecyclerView) {
        super(mListItems);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.loan_application_item_layout, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if(!mItem.getThirdText().toString().isEmpty()) {
            mViewHolder.thirdtitle.setText(mItem.getThirdText());
            mViewHolder.thirdtitle.setVisibility(View.VISIBLE);
        }
        else
        {
            mViewHolder.thirdtitle.setVisibility(View.GONE);
        }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(!mListItems.get(getAdapterPosition()).getLoan_application_no().isEmpty()) {
                            Intent intent = new Intent(mContext, ApproveLoan.class);

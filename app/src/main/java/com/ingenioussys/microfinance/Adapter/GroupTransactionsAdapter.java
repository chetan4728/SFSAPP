...
public class GroupTransactionsAdapter extends BaseAdapter {
    Activity context;
    List<Group> groups;
    public GroupTransactionsAdapter(Activity context, List<Group> groups) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null) {
            ...
            view = inflater.inflate(R.layout.group_transaction_item_list, null);
        ...
        area_name.setText(group.getArea_name()+"-"+group.getCenter_name()+"-"+group.getGroup_name());
        ...
        limit.setText("Member Limit - "+group.getMember_limit());
    ...
    class myClickListener implements View.OnClickListener, PopupMenu.OnMenuItemClickListener {
        ...
        public void onClick(View v) {
            ...
            inflater.inflate(R.menu.tr_popup_group, popup.getMenu());
            popup.show();
        }
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
           ...
           if(menuItem.getItemId() == R.id.view_members)
            {
                ...
                {
                    ((ViewGroupTransactionActivity)context).ViewMemberDetail(id);
                }
            }

...
import com.ingenioussys.microfinance.Adapter.VerificationSurveyAdapter;
...
//                            SurveyList =   AppDatabase.getDatabase(getApplicationContext()).surveyDao().GetAllSurveysForVerification(Integer.parseInt(prefManager.getString("branch_id")));
                            ...
                            if(SurveyList.size()>0) {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        VerificationSurveyAdapter surveyAdapter =  new VerificationSurveyAdapter(ViewSurveyActivity.this,SurveyList);
